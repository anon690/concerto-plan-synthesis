...
(assert (=> true (= (active_u_config step2) (active_u_config (succ step2)))))
(assert (=> true (= (active_u_service step2) (active_u_service (succ step2)))))
(assert (=> true (= (active_u_service0 step2) (active_u_service0 (succ step2)))))
(assert (=> true (= (active_u_config0 step2) (active_u_config0 (succ step2)))))
(assert (=> true (= (active_u_service1 step2) (active_u_service1 (succ step2)))))
(assert (=> true (= (active_u_config1 step2) (active_u_config1 (succ step2)))))
...
(assert (=> true (= (active_u_config step3) (active_u_config (succ step3)))))
(assert (=> true (= (active_u_service step3) (active_u_service (succ step3)))))
(assert (=> true (= (active_u_service0 step3) (active_u_service0 (succ step3)))))
(assert (=> true (= (active_u_config0 step3) (active_u_config0 (succ step3)))))
(assert (=> true (= (active_u_service1 step3) (active_u_service1 (succ step3)))))
(assert (=> true (= (active_u_config1 step3) (active_u_config1 (succ step3)))))
